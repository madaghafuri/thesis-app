...
import { isEmail as isEmailFn } from "@/Components/Multi/isEmail";
...
export function ReactMultiEmail(props: IReactMultiEmailProps) {
                    ...
                    do {
                        ...
                        if (typeof validateResult === "boolean") {
                            if (validateResult) {
                                ...
                                if (allowDisplayName) {
                                    const validateResultWithDisplayName =
                                        isEmail("" + arr[0].trim(), {
                                            allowDisplayName,
                                        });
    ...
    return (
        <div
            className={cn(
                "bg-black text-textcolor rounded-md outline outline-bordercolor outline-1",
        ...
        >
            ...
            <input
                ...
                autoFocus={autoFocus}
                className={cn(
                    "bg-transparent border-none focus:ring-0 focus:bg-transparent w-full",
                    inputClassName
                )}
