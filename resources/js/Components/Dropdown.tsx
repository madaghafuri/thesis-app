...
const Content = ({ align = 'right', width = '48', contentClasses = 'py-1 bg-content dark:bg-content', children }: PropsWithChildren<{ align?: 'left'|'right', width?: '48', contentClasses?: string }>) => {
