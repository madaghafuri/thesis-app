        ...
        >
            <ProjectViewLayout>
                <div className="flex items-center p-3 border-b-[1px] border-bordercolor bg-dark-gray">
                    <Popover
                        open={openAssigneeFilter}
                        onOpenChange={setOpenAssigneeFilter}
                    >
                        <PopoverTrigger asChild>
                            ...
                            >
                                ...
                                {selectedUser.length > 0 ? (
                                    <X
                                        className="h-3 rounded-md hover:bg-bgactive"
                        ...
                        <PopoverContent className="p-0 bg-dark-gray border-bordercolor">
                            <Command className="text-textcolor">
                                <CommandInput
                                    className="ring-0 border-none focus:ring-0 focus:border-none"
                ...
                <div className="text-textcolor px-4 py-2 flex gap-1">
                                ...
                                {section.tasks.map((task) => {
                                    ...
                                    return (
                                        <Dialog>
                                            <ContextMenu key={task.id}>
                                                ...
                                                <ContextMenuContent className="bg-black border-bordercolor w-[10rem]">
                                                                ...
                                                                (section) => {
                                                                    ...
                                                                    return (
                                                                        <ContextMenuItem
                                                                            ...
                                                                            className="p-1 select-none text-sm rounded hover:bg-bgactive"
                                                                            onClick={
                                                                                handleMoveSection
                                                                            }
                                                                        >
                                                    ...
                                                    <DialogTrigger asChild>
                                                        <ContextMenuItem
                                                            className="text-danger text-sm hover:bg-bgactive p-1 flex items-center gap-2 select-none rounded"
                                                            // onClick={
                                                            //     handleDeleteTask
                                                            // }
                                                        >
                                            ...
                                            <DialogContent className="bg-black text-white border-bordercolor">
                                                <DialogHeader>
                                                    <DialogTitle>
                                                        Delete Task
                                                    </DialogTitle>
                    ...
                    <div className="p-1">
                        <Button
                            className="hover:bg-bgactive text-base font-bold text-textweak hover:text-textcolor gap-2"
